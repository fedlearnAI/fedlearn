...
public interface DataReader {
    ...
    */
    String[][] readDataIndex(String dataset,Map<Long, String> idMap) throws IOException;
    ...
    */
    String[][] readDataLine(String sourceFile, List<Integer> seeksList) throws IOException;
