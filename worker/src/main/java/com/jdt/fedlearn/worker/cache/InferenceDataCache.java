...
public class InferenceDataCache {
    ...
    //
    private static List<Integer> checkUid(String inferenceId, String[] uid, String[][] inferenceCacheFile) {
...
//String[][] inferenceCacheFile = getInferenceData(inferenceId, uidList);
    ...
    private static String[][] loadValidateData(String[] uidArray) {
        String validateSource = ConfigUtil.inferenceSourceType();
        DataReader reader;
        //TODO 以反射实现
    ...
    public static String[][] loadAndCachValidate(String inferenceId, AlgorithmType algorithm, String[] uid, String labelName) {
        String[][] sample = loadValidateData(uid);
