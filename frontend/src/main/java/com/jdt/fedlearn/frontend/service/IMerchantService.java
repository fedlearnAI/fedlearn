...
public interface IMerchantService {
     ...
     void createMerchant(MerchantDO merchant);
    /***
     * @description: 查询企业列表
     * @param
     ...
     */
     List<MerchantDO> queryAllMerchant();
     ...
     * @date: 2021/3/8 10:01 上午
     */
     MerchantDO queryMerchantByCode(String code);
     ...
     */
     void updateMerchant(MerchantDO merchant);
}
