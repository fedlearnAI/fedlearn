...
@Component
public class JdchainTaskMapper {
    ...
    public List<JdchainTask> queryAllTask() {
        ...
        if(typedKVEntries != null){
            reslt = Arrays.stream(typedKVEntries).map(typedKVEntry -> JsonUtil.json2Object((String) typedKVEntry.getValue(), JdchainTask.class)).collect(Collectors.toList());
        }
        return reslt;
    }
     ...
     * @return: com.jdt.fedlearn.frontend.mapper.entity.JdchainTask
     * @author: geyan29
