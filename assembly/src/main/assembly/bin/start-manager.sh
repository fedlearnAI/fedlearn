...
if [[ -n "$BITS" ]]; then
    JAVA_MEM_OPTS=" -server -Xmx12g -Xms12g -Xmn2g  -Xss256k -XX:+DisableExplicitGC -XX:+CMSClassUnloadingEnabled -XX:+UseConcMarkSweepGC -XX:+CMSParallelRemarkEnabled  -XX:LargePageSizeInBytes=128m -XX:+UseFastAccessorMethods -XX:+UseCMSInitiatingOccupancyOnly -XX:CMSInitiatingOccupancyFraction=70 -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/export/"
else
...
MAIN_CLASS="com.jdt.fedlearn.manager.ManagerHttpApp"
APP_CONFIG=""
