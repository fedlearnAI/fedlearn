...
public class Response {
    ...
    public Response(String compressedJsonStr) {
        String string = HttpClientUtil.unCompress(compressedJsonStr);
        parseJson(string);
    }
    ...
    @JsonCreator
    public Response(@JsonProperty(required = true, value = "code") int code) {
        this.code = code;
    }
    ...
    public void parseJson(String jsonStr) {
        ...
        Response p3r;
        try {
            p3r = mapper.readValue(jsonStr, Response.class);
            this.code = p3r.code;
