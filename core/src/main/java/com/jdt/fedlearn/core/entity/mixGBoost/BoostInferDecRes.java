 ...
 * @author zhangwenxi
 */
public class BoostInferDecRes implements Message {
    private final List<DistributedPaillierNative.signedByteArray[]> body;

    public BoostInferDecRes(List<DistributedPaillierNative.signedByteArray[]> in) {
        this.body = in;
    }
