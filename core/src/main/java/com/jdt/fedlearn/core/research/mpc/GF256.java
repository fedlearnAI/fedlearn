...
//According to the x and y of each party, the constant term of Lagrange polynomial is solved
public class GF256 {
    ...
    public static byte eval(byte[] p, byte x) {
        ...
        return result;
    } //The polynomial result = P [n-1] x ^ (n-1) + P [n-2] x ^ (n-2) +... + P [1] x + P [0] is obtained by using the array P, that is, the secrets of each party
    ...
    public static int degree(byte[] p) {
        ...
        return 0;
    } // The highest power of polynomial
