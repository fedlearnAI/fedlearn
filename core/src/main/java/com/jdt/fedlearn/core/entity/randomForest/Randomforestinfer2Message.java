...
public class Randomforestinfer2Message implements Message {
    ...
    public Randomforestinfer2Message(String modelString, String[] inferenceUid, double[] localPredict, String type) {
