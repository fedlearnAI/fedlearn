...
public class TestMixGBoost {
   ...
   public void testInitControl() {
      ...
      mixGBParameters[1] = new MixGBParameter(1.0,1.0, 10, 1, 0, ObjectiveType.regLogistic,null, 3,2,1,0.3,33,0.6,"", 512);
      mixGBParameters[2] = new MixGBParameter(1.0,1.0, 10, 1, 0, ObjectiveType.multiSoftmax,null, 3,2,1,0.3,33,0.6,"", 512);
      mixGBParameters[3] = new MixGBParameter(1.0,1.0, 10, 1, 0, ObjectiveType.binaryLogistic,null, 3,2,1,0.3,33,0.6,"", 512);
   ...
   public void testAfterLeafIntoStartNode() {
      ...
      MixGBParameter parameter = new MixGBParameter(1.0,1.0, 1, 1, 0, ObjectiveType.regLogistic,null, 3,2,1,0.3,33,0.6,"", 512);
   ...
   public void testControlActuallyDealWithWj() {
      ...
      Assert.assertEquals(req.getRecordId(), 1);
   ...
   public void testNeedVerticalControlFalse() {
      ...
      node.setNodeGH(new DoubleTuple2(60, 3));
      node.setInstanceIdSpaceSet(new HashSet<>(Arrays.asList(0, 1, 2, 3, 4)));
      MixGBParameter parameter = new MixGBParameter(1.0,1.0, 1, 1, 0, ObjectiveType.regLogistic,null, 3,2,1,0.3,33,0.6,"", 512, 1);
      Set<Integer> commonIdSet = new HashSet<>(Arrays.asList(0, 1));
   ...
   public void testControlHorizontalSplitIntoWj() {
      ...
      node.setNodeGH(new DoubleTuple2(60, 3));
      node.setInstanceIdSpaceSet(new HashSet<>(Arrays.asList(0, 1, 2)));
      MixGBParameter parameter = new MixGBParameter(1.0,1.0, 10, 1, 0, ObjectiveType.regLogistic,null, 3,2,1,0.3,33,0.6,"", 512);
   ...
   public void testControlHorizontalSplit() {
      ...
      MixGBParameter parameter = new MixGBParameter(1.0,1.0, 10, 1, -100, ObjectiveType.regLogistic,null, 3,2,1,0.3,33,0.6,"", 512);
      Map<String, Set<ClientInfo>> allFeatures = new HashMap<>();
      allFeatures.put("fea1", new HashSet<>(Collections.singletonList(clientInfos.get(0))));
      allFeatures.put("fea2", new HashSet<>(clientInfos));
      allFeatures.put("fea3", new HashSet<>(clientInfos));
      ...
      BoostBodyReq req1 = (BoostBodyReq) requests.get(1).getBody();
      Assert.assertEquals(req1.getRecordId(), -1);
      BoostBodyReq req2 = (BoostBodyReq) requests.get(2).getBody();
      Assert.assertEquals(req2.getRecordId(), -1);
   }
   ...
   public void testInferenceControl() {
      ...
      MixGBoost mixGBoost = new MixGBoost(predUid, inferScoreMap, false, null, null, clientInfos);

      BoostInferenceInitRes res0 = new BoostInferenceInitRes(false, new int[]{1}, "");
      BoostInferenceInitRes res1 = new BoostInferenceInitRes(false, null, "");
      BoostInferenceInitRes res2 = new BoostInferenceInitRes(false, null, "");
      String content0 = "first_round_predict=0\n" +
              "squareloss\n" +
      ...
      String content1 = "";
      String content2 = "first_round_predict=0\n" +
              "squareloss\n" +
              "finalRecordIdTreeNodeMap\n" +
              "recordId=5,depth=2,leaf=8.6931842621821640,parentRecordId=-1" +
              "recordId=1,depth=1,leaf=27.3802053742102270\n";
      res0.setContent(content0);

      res1.setContent(content1);
      res2.setContent(content2);
      List<CommonResponse> resList = new ArrayList<>();
      resList.add(new CommonResponse(clientInfos.get(0), res0));
      resList.add(new CommonResponse(clientInfos.get(1), res1));
      resList.add(new CommonResponse(clientInfos.get(2), res2));
   ...
   @Test
   public void testInferenceControlAllLeaf() {
      String[] predUid = new String[]{"0A", "1B", "2C"};
      double[] predV = new double[]{0.1, 0.2, 0.3};
      Map<String, Double> inferScoreMap = new HashMap<>();
      inferScoreMap.put(predUid[0], predV[0]);
      ...
      BoostInferenceInitRes res0 = new BoostInferenceInitRes(false, null, "");
      BoostInferenceInitRes res1 = new BoostInferenceInitRes(false, null, "");
      BoostInferenceInitRes res2 = new BoostInferenceInitRes(false, null, "");
      String content0 = "first_round_predict=0\n" +
              "logloss\n" +
   ...
   @Test
   public void testInferenceControlEmpty() {
      String[] predUid = new String[]{"0A", "1B", "2C"};
      double[] predV = new double[]{0.1, 0.2, 0.3};
      Map<String, Double> inferScoreMap = new HashMap<>();
      inferScoreMap.put(predUid[0], predV[0]);
   ...
   public void testInitInference() {
      MixGBoost mixGBoost = new MixGBoost(new MixGBParameter());
      String[] predUid = new String[]{"0A", "1B", "2C"};
      List<CommonRequest> requests = mixGBoost.initInference(clientInfos, predUid);
      Assert.assertEquals(clientInfos.size(), requests.size());
      CommonRequest first = requests.get(0);
      Message message = first.getBody();
