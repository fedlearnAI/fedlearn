 ...
 */
public class TestDisRandomForestBinary {
    //服务端维护
    private static final String taskId = "181";
    ...
    public void testTrainAndTest() throws IOException {
        ...
        for (ClientInfo client : clientInfos) {
            modelMap.put(client, new DistributedRandomForestModel());
        }
        ...
        for (Map.Entry<ClientInfo, Model> x : modelMap.entrySet()) {
            DistributedRandomForestModel boostModel = (DistributedRandomForestModel) x.getValue();
    ...
    public void testInference() throws IOException {
        ...
        for (ClientInfo clientInfo : clientInfos) {
            ...
            DistributedRandomForestModel tmp = new DistributedRandomForestModel();
...
//        String[] predictUid = new String[]{"2891", "16484"};
    ...
    public static void main(String[] args) throws IOException {
        TestDisRandomForestBinary testRandomForest = new TestDisRandomForestBinary();
