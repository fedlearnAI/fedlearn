 ...
 * TODO 在测试中增加交叉验证选项，
 */
public class TestMixGBoostRegHorizontal {
    //服务端维护
    ...
    private static MixGBParameter parameter = new MixGBParameter(1.0, 1.0, 10, 1, 0, ObjectiveType.regSquare, metrics, 2, 2, 1, 0.3, 33, 0.6, "", 512);
...
//            System.out.println(x.getKey().url() + " =-S1C=-=-: " + boostModel.s1C);
    ...
    public static void main(String[] args) throws IOException {
        TestMixGBoostRegHorizontal mixGBoostRegHorizontal = new TestMixGBoostRegHorizontal();
