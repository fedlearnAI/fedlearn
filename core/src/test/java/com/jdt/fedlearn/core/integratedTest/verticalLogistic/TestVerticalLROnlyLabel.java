 ...
 */
public class TestVerticalLROnlyLabel {
    //服务端维护
...
//    private static final String labelName = "y";
    ...
    public void init() {
        ...
        for (int i = 0; i < partnerSize; i++) {
            ...
            String inferenceFileName = "inference" + (i+1) + ".csv";
...
//        String[] predictUid = DataParseUtil.loadInferenceUidList(baseDir + "inference0_onlyLabel.csv");
        String[] predictUid = new String[]{"0kU", "1mX" ,"3PA" , "4oX" ,"5Ng"};
...
//        return result;
    ...
    public static void main(String[] args) throws IOException {
        TestVerticalLROnlyLabel verticalLR = new TestVerticalLROnlyLabel();
        verticalLR.init();
