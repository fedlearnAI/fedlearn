...
//    }
    ...
    private final KernelDispatchJavaPhaseType[] algorithmTypes = {KernelDispatchJavaPhaseType.UPDATE_METRIC, KernelDispatchJavaPhaseType.COMPUTE_LOSS,
            KernelDispatchJavaPhaseType.VALIDATION_INIT, KernelDispatchJavaPhaseType.VALIDATION_FILTER,KernelDispatchJavaPhaseType.EMPTY_REQUEST,
            KernelDispatchJavaPhaseType.VALIDATION_RESULT, KernelDispatchJavaPhaseType.INFERENCE_FILTER,KernelDispatchJavaPhaseType.INFERENCE_EMPTY_REQUEST,KernelDispatchJavaPhaseType.INFERENCE_RESULT};
