...
public class TestRandomForestModel {
...
//        Assert.assertEquals(subUid,res);        String[] res = model.inferencePhase1(rfInferenceData, init);
//        Assert.assertEquals(subUid,res);
    ...
    public void testGetModelType(){
        RandomForestModel model = new RandomForestModel();
        assertEquals(model.getModelType(), AlgorithmType.RandomForest);
    }
