 ...
 * TODO 在测试中增加交叉验证选项，
 */
public class TestMixGBoostRegHouse {
    //服务端维护
    ...
    private final String baseDir = "./src/test/resources/house/";
...
//        String[] predictUid = new String[]{"291B", "TEST"};
    ...
    public static void main(String[] args) throws IOException {
        TestMixGBoostRegHouse mixGBoostRegVertical = new TestMixGBoostRegHouse();
