...
public class MixGBTrainDataTest {
    ...
    public void testGetInstanceFeatureValue() {
        ...
        MixGBTrainData data = new MixGBTrainData(input, uids, features, new ArrayList<>());
        double feavalue = data.getInstanceFeatureValue(0, "AveOccup");
        Assert.assertEquals(feavalue, 2.109841823577881);
    }
    ...
    @Test
    public void testGetUsageIdFeatureValue() {
        Tuple3<String[][], String[], Features> compoundInput = StructureGenerate.mixgbTrainInputStd();
        String[][] input = compoundInput._1().get();
        String[] uids = compoundInput._2().get();
        Features features = compoundInput._3().get();
        ...
        MixGBTrainData data = new MixGBTrainData(input, uids, features, new ArrayList<>());
        Map<Integer, Double> res = data.getUsageIdFeatureValue(new HashSet<>(Arrays.asList(0,1,2,3)), 0);
        Map<Integer, Double> trueMap = new HashMap<>();
        trueMap.put(0, 21.0);
        trueMap.put(1, 29.0);
        trueMap.put(2, 12.0);
    ...
    @Test
    public void testGetInstanceIdToIndexMap() {
        Tuple3<String[][], String[], Features> compoundInput = StructureGenerate.mixgbTrainInputStd();
        String[][] input = compoundInput._1().get();
        String[] uids = compoundInput._2().get();
        Features features = compoundInput._3().get();
        ...
        MixGBTrainData data = new MixGBTrainData(input, uids, features, new ArrayList<>());
        Map<Integer, Integer> indexMap = data.getInstanceIdToIndexMap();
    ...
    public void testGetLocalLabeledId() {
        ...
        MixGBTrainData data = new MixGBTrainData(input, uids, features, new ArrayList<>());
        Map<Integer, Integer> indexMap = data.getLocalLabeledId();
        Map<Integer, Integer> trueMap = new HashMap<>();
        trueMap.put(0, 0);
        trueMap.put(1, 1);
        trueMap.put(2, 2);
