 ...
 * TODO 在测试中增加交叉验证选项，
 */
public class TestMixGBLabelDistributed {
    //服务端维护
    private final String taskId = "53";
    private final String modelToken = taskId + "_" + AlgorithmType.MixGBoost;
    private static final MetricType[] metrics = new MetricType[]{MetricType.MAPE};
    private static final MixGBParameter parameter = new MixGBParameter(1.0, 1.0, 10, 1, 0, ObjectiveType.regSquare, metrics, 3, 2, 1, 0.3, 33, 0.6, "", 512);
    ...
    private final String baseDir = "./src/test/resources/regressionF/";
...
//        String[] predictUid = new String[]{"291", "292", "293", "294", "295", "296"};
    ...
    public static void main(String[] args) throws IOException {
        TestMixGBLabelDistributed mixGBLabelDistibuted = new TestMixGBLabelDistributed();
        mixGBLabelDistibuted.init();
        mixGBLabelDistibuted.testTrainAndTest();
        mixGBLabelDistibuted.testInference();
    }
}
