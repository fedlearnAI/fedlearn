...
public class TestMixGBHori {
    ...
    private final String baseDir = "./src/test/resources/HFL/hori/";
...
//            System.out.println(x.getKey().url() + " =-S1C=-=-: " + boostModel.s1C);
    ...
    public void testInference() throws IOException {
        ...
        String[] predictUid = DataParseUtil.loadInferenceUidList(baseDir + "train0.csv");
        System.out.println("predictUid.length " + predictUid.length);
        long start = System.currentTimeMillis();
        double[] label = Arrays.stream(DataParseUtil.loadInferenceLabelList(baseDir + "train0.csv")).mapToDouble(Double::doubleValue).toArray();
    ...
    public static void main(String[] args) throws IOException {
        TestMixGBHori mixGBoostRegHorizontal = new TestMixGBHori();
