...
import com.jdt.fedlearn.core.dispatch.FederatedKernel;
...
//    private static final FederatedKernelParameter parameter = new FederatedKernelParameter(3, 100, 400, 5, 0.005, 200, metrics, NormalizationType.STANDARD, 1, 2);
    private static final FederatedKernelParameter parameter = new FederatedKernelParameter.Builder(metrics,1).kernelType(3).seed(100).mapdim(400).maxIter(5).scale(0.005).batchSize(200).normalizationType(NormalizationType.STANDARD).earlyStoppingRounds(2).useDp("false").dpDelta(0).dpEpsilon(0).dpType("OUTPUT_PERTURB").build();
    private static final FederatedKernel algo = new FederatedKernel(parameter);
...
//    private final String labelTag = "label";
    ...
    public void setUp() {
        ...
        if (modelMap.size() == 0) {
            modelMap.put(client1, new FederatedKernelModel());
            modelMap.put(client2, new FederatedKernelModel());
            modelMap.put(client3, new FederatedKernelModel());
        }
    ...
    public void testTrain() throws IOException {
        ...
        for (Map.Entry<ClientInfo, Model> x : modelMap.entrySet()) {
            FederatedKernelModel model = (FederatedKernelModel) x.getValue();
...
//        String[] predictUid = new String[]{"okU", "1mX", "3PA", "4oX"};
        ...
        for (ClientInfo clientInfo : clientInfos) {
            ...
            FederatedKernelModel tmp = new FederatedKernelModel();
...
//        objectMap.put("privKeyStr","{\"t\":1,\"bitLen\":1024,\"rank\":1,\"hi\":{\"byteArr\":\"R42atN5V+o4QvcD9eabCR8UjzinS1r6JxnSRUeNaceFg/9urLPBU5RgQ2fDQqwuj0h77LJUjMQu/odsSJSm+3j/IKKqGCESi6GFbxECzKC/GN/7+FhcMCryaz2abTK86syRvJSwAfZvcP9i1wtvoKNzPjmab5TwE366gXnRy8Pgg\",\"isNeg\":false,\"scale\":1},\"n\":{\"byteArr\":\"7S60X0kiyvGKZ0YBdEUE5q06A0nX4SA7E0N/8jHVjG0GKf+ULnGmp6J1hW/yveAqIzsyaWf5fJAcmn7KEW9+vAXdopMhBJ9WYSfc1JSLDuwXaltXCrfnNG/Oiy8+qVI3tBoPMXbdeNCFQSQuqrw6ejCkIZUXU3ZbZ0LAAEbY/UI=\",\"isNeg\":false,\"scale\":1},\"thetaInvmod\":{\"byteArr\":\"HwMPdg9QN4yrQyYWEIWYCEW6Eunb1XVPWSdkmxYucuMfMwkQiRJiVEQfihey7dvhp7g1ZoBqkMVyDWdmy406Kx9hOwCTalcfQscKoKk39KbMYN8xEqG7ZZuCATu+tpAJLU5KC3jw5L569z45rNZp7XSCb1MOWyS6CqJeveaSyw8=\",\"isNeg\":false,\"scale\":1},\"nFact\":6}");
    ...
    public static void main(String[] args) throws IOException {
        TestFederatedKernel testFederatedKernel = new TestFederatedKernel();
        testFederatedKernel.setUp();
        testFederatedKernel.testTrain();
        testFederatedKernel.testInference();
    }
}
